# 2026 INDEX — বছরের সূচিপত্র

> নতুন project = নতুন এক লাইন। Status বদলালে emoji update।

| project | কী | status | main files |
|---|---|---|---|
...
1. আগে project folder, পরে এখানে লাইন — উল্টো না
2. project-প্রতি এক লাইন; "কী" ঘরে সর্বোচ্চ এক লাইন
3. Status: 🚧 exam / ✅ passed / ❌ abandoned
4. বছর শেষে এই file-এর নিচে এক লাইনের yearly summary
